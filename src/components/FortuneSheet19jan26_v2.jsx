  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.notesSection}>
        <h3 style={styles.notesTitle}>📌 How Image Overlay Works:</h3>
        ...
        <div style={styles.note}>
          <strong>3. Manage Images:</strong> Images are stored as overlays positioned on top of the sheet. They save/export with your data.
        </div>
        <div style={styles.note}>
          <strong>4. Remove Image:</strong> Select a cell with an image → Click "Remove Image"
        </div>
        <div style={styles.note}>
          <strong>Note:</strong> Images are overlaid using absolute positioning. If you resize columns/rows after inserting images, you may need to re-insert them.
        </div>
      </div>
    </div>
  );
